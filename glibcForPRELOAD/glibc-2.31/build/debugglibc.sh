...
SOURCE_DIR="/home/LLVM_MYSQL/knob_profiler/glibcForPRELOAD/glibc-2.31"
BUILD_DIR="/home/LLVM_MYSQL/knob_profiler/glibcForPRELOAD/glibc-2.31/build/"
CMD_FILE="/home/LLVM_MYSQL/knob_profiler/glibcForPRELOAD/glibc-2.31/build/debugglibc.gdb"
CONTAINER=false
DIRECT=true
STATIC=false
SYMBOLSFILE=true
...
run --library-path /home/LLVM_MYSQL/knob_profiler/glibcForPRELOAD/glibc-2.31/build:/home/LLVM_MYSQL/knob_profiler/glibcForPRELOAD/glibc-2.31/build/math:/home/LLVM_MYSQL/knob_profiler/glibcForPRELOAD/glibc-2.31/build/elf:/home/LLVM_MYSQL/knob_profiler/glibcForPRELOAD/glibc-2.31/build/dlfcn:/home/LLVM_MYSQL/knob_profiler/glibcForPRELOAD/glibc-2.31/build/nss:/home/LLVM_MYSQL/knob_profiler/glibcForPRELOAD/glibc-2.31/build/nis:/home/LLVM_MYSQL/knob_profiler/glibcForPRELOAD/glibc-2.31/build/rt:/home/LLVM_MYSQL/knob_profiler/glibcForPRELOAD/glibc-2.31/build/resolv:/home/LLVM_MYSQL/knob_profiler/glibcForPRELOAD/glibc-2.31/build/mathvec:/home/LLVM_MYSQL/knob_profiler/glibcForPRELOAD/glibc-2.31/build/support:/home/LLVM_MYSQL/knob_profiler/glibcForPRELOAD/glibc-2.31/build/crypt:/home/LLVM_MYSQL/knob_profiler/glibcForPRELOAD/glibc-2.31/build/nptl:${BUILD_DIR}/nptl_db __COMMANDLINE__ __DIRECT__
__BREAKPOINTS__
EOF
}
...
WAIT_FOR_DEBUGGER=1 /home/LLVM_MYSQL/knob_profiler/glibcForPRELOAD/glibc-2.31/build/testrun.sh --tool=container ${TESTCASE} &
gdb -x ${TESTCASE}.gdb
elif [ "$STATIC" == true ]
then
gdb ${TESTCASE}
